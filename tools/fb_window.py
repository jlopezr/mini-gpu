...
El protocolo de entrada es una línea JSON por refresco, por `stdin`:

    {"front": "C:/.../front.bin", "back": null, "title": "PC=0x40 instr=120"}

Cada clave que venga con ruta se repinta; una clave ausente deja su panel como
estaba. Cerrar la ventana termina el proceso, y el depurador se entera sola la
