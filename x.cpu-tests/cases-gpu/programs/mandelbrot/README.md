...
```powershell
.venv/Scripts/python.exe x.cpu-tests/cases-gpu/programs/mandelbrot/run.py
```
...
```powershell
python run_gpu_tests.py cases-gpu/programs/mandelbrot/test.json --backend gpu-simulator
```
...
```powershell
.venv/Scripts/python.exe x.cpu-tests/run_gpu_tests.py x.cpu-tests/cases-gpu/programs/mandelbrot/test.json --backend gpu-simulator
```
...
```powershell
.venv/Scripts/python.exe x.cpu-tests/cases-gpu/programs/mandelbrot/run.py --reference-only
```
