...
module gpu_control_tb;
    ...
    initial begin
        ...
        fresh;
        write_word(32'h00100000,32'h40201234); // MOVI R1,0x1234
        write_word(32'h00100004,32'h5c8001ff); // MOVHI R4,0x01ff
        write_word(32'h00100008,32'h4c84fffc); // ORI R4,R4,0xfffc
        ...
        read_word(32'h01fffffc);
        if(word_result!==32'h1234) $fatal(1,"high SDRAM STORE failure");
        $display("PASS fetch above BRAM range and GPU STORE/LOAD of final SDRAM word");
        $finish;
    end
