...
module cpu_mmio_error_tb;
  ...
  task check(input [15:0] blk,input [15:0] addr,input wr,input bad);
    begin
      ...
      if(!bad && !wr && blk==16'h8000 && addr==16'h000c && debug_data!==32'h0000_0235)
        $fatal(1,"DEVICES = %h, esperado 00000235",debug_data);
  ...
  initial begin
    ...
    for(w=0;w<2;w=w+1) begin
      ...
      // ---- SERIAL: DATA, STATUS, PEEK -----------------------------------
      check(16'h8010,16'h0000,w,0);
      check(16'h8010,16'h0004,w,0);
      check(16'h8010,16'h0008,w,0);
