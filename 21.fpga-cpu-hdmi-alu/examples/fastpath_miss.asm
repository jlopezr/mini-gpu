; Mide en la placa lo que ahorra el camino rapido de la 21. Mitad con FALLO.
;
; Va en pareja con fastpath_hit.asm, que es este mismo fichero con UN caracter
; distinto: alli el REM lee R2 y aqui lee R3.
;
...
bucle:
    DIV   R5, R1, R2
    REM   R6, R1, R3           ; falla: R3 vale lo mismo, pero es otro numero
    ADDI  R4, R4, -1
    BNE   R4, R0, bucle
