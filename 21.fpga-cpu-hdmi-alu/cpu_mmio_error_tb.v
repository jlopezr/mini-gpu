...
module cpu_mmio_error_tb;
  ...
  mmio_decoder #(.FOLDER(8'd21),.HAS_SERIAL(1),
    .VIDEO_REGISTERS(64'h7f)) decoder(
  ...
  monitor_mem_adapter_128 host_adapter(.clk(clk),.reset(reset),.init_done(1'b1),
    ...
    .mem_write_enable(mon_write),
      .mem_write_word(32'd0), .mem_write_word_enable(1'b0),.mem_read_enable(mon_read),.mem_read_word(mon_word),
