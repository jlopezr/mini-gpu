 ...
 * - R0 is hardwired to zero: writes are dropped, reads always return zero.
 *
 ...
 * `(addr == 0) ? 0 : ...` would add a mux on the read path, which is the
 * critical path we do not want to lengthen. See docs/registro-cero.md.
 */
