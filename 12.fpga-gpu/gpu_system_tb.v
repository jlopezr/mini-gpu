...
module gpu_system_tb;
    // Las direcciones de MMIO v2 con nombre, ANTES de usarlas (consejo de la
    // 21). En esta familia importa el doble: un `32'h8000_0100` suelto no se
    // distingue de un `32'hc8000000`, que es una instruccion, no una direccion.
    ...
    // WARP_RETIRED estaba en +0x14 en v1 y ahora esta en +0x10: el contador
    // global se fue a GPU PERFORMANCE y dejo de estar intercalado.
