...
module top_bl8(input clk_25mhz, output [7:0] led, output wifi_gpio0,
    ...
    monitor #(.VERSION_MAJOR(8'd3),.VERSION_MINOR(8'd22),
        ...
        // MMIO v2: una ventana por bloque presente, y las cinco se usan. El
        // final es EXCLUSIVO y se ajusta a lo que el bloque implementa, no a
        // sus 64 KiB del mapa.
        // SYSTEM (§5): siete palabras.
        .WINDOW0_BASE(33'h0_8000_0000),.WINDOW0_END(33'h0_8000_001C),
        // VIDEO (§9): diez registros, CTRL..VIDEO_TX.
