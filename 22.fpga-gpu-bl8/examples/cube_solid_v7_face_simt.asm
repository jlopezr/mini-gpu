; Cubo solido v7: vertices y caras procesados en paralelo.
;
; Las lanes 0..7 rotan y proyectan un vertice cada una. Despues las lanes 0..5
; procesan una cara cada una y escriben dos slots fijos. Los 64 hilos reutilizan
; el rasterizador incremental de v4 sobre doce slots. No hay tabla de frames.
...
vertices_ready:
        ...
        ; Seis lanes procesan seis caras y escriben dos slots fijos cada una.
        MOVI  R2, 6
        SSY   face_setup_ready
        BGE   R1, R2, face_setup_ready
        ...
        MOVI  R3, 112             ; dos descriptores de 56 bytes
        MUL   R3, R1, R3
        ADD   R4, R4, R3

        ; Culling de la cara con (p0,p1,p2).
        ...
        SSY   face_done
        BGE   R0, R18, face_hidden
        MOVI  R3, 2
face_triangle_loop:
        ; Cargar los tres puntos del triangulo actual.
        MOVI  R10, cube_points
        ADD   R11, R6, R6
        ADD   R11, R11, R11
        ADD   R11, R11, R11
        ...
        ADD   R21, R13, R0
        SSY   v7_minx1_ok
        BGE   R14, R18, v7_minx1_ok
        ADD   R18, R14, R0
v7_minx1_ok:
        SSY   v7_maxx1_ok
        BGE   R19, R14, v7_maxx1_ok
        ADD   R19, R14, R0
v7_maxx1_ok:
        SSY   v7_minx2_ok
        BGE   R16, R18, v7_minx2_ok
        ADD   R18, R16, R0
v7_minx2_ok:
        SSY   v7_maxx2_ok
        BGE   R19, R16, v7_maxx2_ok
        ADD   R19, R16, R0
v7_maxx2_ok:
        SSY   v7_miny1_ok
        BGE   R15, R20, v7_miny1_ok
        ADD   R20, R15, R0
v7_miny1_ok:
        SSY   v7_maxy1_ok
        BGE   R21, R15, v7_maxy1_ok
        ADD   R21, R15, R0
v7_maxy1_ok:
        SSY   v7_miny2_ok
        BGE   R17, R20, v7_miny2_ok
        ADD   R20, R17, R0
v7_miny2_ok:
        SSY   v7_maxy2_ok
        BGE   R21, R17, v7_maxy2_ok
        ADD   R21, R17, R0
v7_maxy2_ok:
        MOVI  R22, 1
        SHR   R18, R18, R22
        ...
        ADDI  R3, R3, -1
        BEQ   R3, R0, face_done
        ADD   R7, R8, R0          ; segundo triangulo: p0,p2,p3
        ADD   R8, R28, R0
        BRA   face_triangle_loop
...
face_inactive_loop:
        ...
        ADDI  R4, R4, 56
        ADDI  R3, R3, -1
        BNE   R3, R0, face_inactive_loop
face_done:
face_setup_ready:
        BAR

        ; Solo tid 0 actualiza el angulo.
        SSY   geometry_ready
