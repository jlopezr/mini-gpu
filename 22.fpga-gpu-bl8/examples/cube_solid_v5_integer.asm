; Cubo solido v5: geometria entera calculada por la MiniGPU.
;
; La lane global 0 rota y proyecta los ocho vertices, hace back-face culling
; y genera los seis descriptores de triangulo en RAM. Los 64 hilos reutilizan
...
frame_loop:
        ; Solo tid 0 construye vertices y triangulos. Los demas esperan.
        SSY   geometry_ready
