...
# PerfMixin: esta carpeta tiene `cpu_perf_counters.v` desde la fase 3.5, pero
# su cliente no sabia preguntarle. Nunca tuvo los comandos GET_CYCLES/
# GET_INSTRUCTIONS --llegaron en la 18-- asi que al pasar los contadores a MMIO
# se quedo con el hardware contando y sin nadie que lo leyera desde el PC.
