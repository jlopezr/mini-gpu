...
- Los saltos deben llevar a todos los hilos activos al mismo PC. Si difieren,
  se lanza `UnsupportedDivergence` sin modificar la instrucción ni registrar un
  fallo de la ISA. La pila de reconvergencia queda pendiente; actualmente una
  máscara vacía significa que el warp no tiene trabajo, sin rutas suspendidas.
