...
Fuentes de selección: [backend CPU FPGA](../x.tests/backends/fpga.py),
[backend CPU simulado](../x.tests/backends/simulator.py) y
[backend GPU FPGA](../x.tests/backends/gpu_fpga.py).
